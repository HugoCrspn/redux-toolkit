...
const figurineSlice = createSlice({
    name: "figurine",
    initialState: [
        {id: 1, number: 503, name: "Bartman", category: "Pop Television", description: "Offert pas Jacques lors de mon anniversaire, état neuf", purchaseDate: "20/07/2022", box: true, chase: false, exclusive: true, imgUrl: "./img/bartman.jpg"},
